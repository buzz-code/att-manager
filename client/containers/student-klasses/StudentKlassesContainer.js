...
const getFilters = ({ studentsByYear, klasses }) => [
  ...
  { field: 'student_klasses.start_date', label: 'תאריך התחלה מ', type: 'date', operator: 'date-after', defaultValue: moment().format('YYYY-MM-DD') },
  ...
  { field: 'student_klasses.end_date', label: 'תאריך סיום עד', type: 'date', operator: 'date-before', defaultValue: moment().format('YYYY-MM-DD') },
];
